		...
		<div id="breadcrumb" class="container breadcrumb-wrap clr-fix" style="height:60px; line-height:60px;">
 	    ...
 	    <section class="page" id="page1">
    		...
    		<div class="page-wrap">
	    		<div class="clr-fix">
	    			<br>
					<form action="${path2 }/sales/inSalesPro.do" method="post">
								...
								<tr>
									...
									<td>
										<div class="item_fr">
											...
											<img src="${path2 }/resources/upload/${product.img1 }" alt="${product.pname }" width="120" />
											<br>
											<h4>제품 설명</h4>
											<p>${product.com }</p>
										</div>
								...
								<tr class="result_item">
									...
									<td>
										...
										<div class="item_fr">
											...
											<strong>우편 번호</strong> : <input type="text" name="postcode" id="postcode" class="input" style="display:inline-block; width:85%;" required><br><br>
